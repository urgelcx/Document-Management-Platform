...
<div class="container">
    <div class="form row" style="position: relative;left:400px; top: 30px">
        <div class="form-horizontal col-md-offset-3" id="login_form">
            ...
            <div class="col-md-9">
                <form method="post" action="<%=path%>/${username}/Admin_modify" enctype="multipart/form-data">
                    <div class="form-group">
                        <div class="name">
                            <label>用户名:</label>
                        </div>
                        <i class="fa fa-user fa-lg"></i>
                        <input class="form-control required" type="text"  value="${username}" id="username" name="username" />
                    </div>
                    <div class="form-group">
                        <div class="name">
                            <label>密码:</label>
                        ...
                        <input class="form-control required" type="text"  value="${password}" id="password" name="password" />
                    </div>
                    <div class="form-group">
                        <div class="name">
                            <label>联系方式:</label>
                        ...
                        <input class="form-control required" type="text"  value="${telnum}" id="telnum" name="telnum" maxlength="11"/>
                    </div>
                    <div class="form-group">
                        <div class="name">
                            <label>队伍名称:</label>
